...
bb1:                                              ; preds = %bb4
  ...
  br label %bb_while_2_17_cond

bb_while_2_17_cond:                               ; preds = %bb_while_2_17_whilestms, %bb1
  %r103 = load i32, ptr %r100, align 4
  %r104 = load i32, ptr %r101, align 4
  %r105 = icmp slt i32 %r103, %r104
  br i1 %r105, label %bb_while_2_17_whilestms, label %bb_while_2_17_bre

bb_while_2_17_whilestms:                          ; preds = %bb_while_2_17_cond
...
bb_while_2_17_bre:                                ; preds = %bb_while_2_17_cond
...
bb2:                                              ; preds = %bb5
  ...
  br label %bb_while_2_29_cond

bb_while_2_29_cond:                               ; preds = %bb_if_4_55_end, %bb2
  ...
  br i1 %r120, label %bb_while_2_29_whilestms, label %bb_while_2_29_bre

bb_while_2_29_whilestms:                          ; preds = %bb_while_2_29_cond
  ...
  br i1 %r125, label %bb_if_4_31_true, label %bb_if_4_31_false

bb_if_4_31_true:                                  ; preds = %bb_while_2_29_whilestms
  %r126 = load i32, ptr @ptr, align 4
  %r127 = add i32 %r126, 1
  store i32 %r127, ptr @ptr, align 4
  br label %bb_if_4_31_end

bb_if_4_31_false:                                 ; preds = %bb_while_2_29_whilestms
  br label %bb_if_4_31_end

bb_if_4_31_end:                                   ; preds = %bb_if_4_31_false, %bb_if_4_31_true
  %r128 = load i32, ptr %r114, align 4
  %r129 = icmp eq i32 %r128, 60
  br i1 %r129, label %bb_if_4_35_true, label %bb_if_4_35_false

bb_if_4_35_true:                                  ; preds = %bb_if_4_31_end
  %r130 = load i32, ptr @ptr, align 4
  %r131 = sub i32 %r130, 1
  store i32 %r131, ptr @ptr, align 4
  br label %bb_if_4_35_end

bb_if_4_35_false:                                 ; preds = %bb_if_4_31_end
  br label %bb_if_4_35_end

bb_if_4_35_end:                                   ; preds = %bb_if_4_35_false, %bb_if_4_35_true
  %r132 = load i32, ptr %r114, align 4
  %r133 = icmp eq i32 %r132, 43
  br i1 %r133, label %bb_if_4_39_true, label %bb_if_4_39_false

bb_if_4_39_true:                                  ; preds = %bb_if_4_35_end
  ...
  br label %bb_if_4_39_end

bb_if_4_39_false:                                 ; preds = %bb_if_4_35_end
  br label %bb_if_4_39_end

bb_if_4_39_end:                                   ; preds = %bb_if_4_39_false, %bb_if_4_39_true
  %r140 = load i32, ptr %r114, align 4
  %r141 = icmp eq i32 %r140, 45
  br i1 %r141, label %bb_if_4_43_true, label %bb_if_4_43_false

bb_if_4_43_true:                                  ; preds = %bb_if_4_39_end
...
bb_if_4_43_false:                                 ; preds = %bb_if_4_39_end
  br label %bb_if_4_43_end

bb_if_4_43_end:                                   ; preds = %bb_if_4_43_false, %bb_if_4_43_true
  %r148 = load i32, ptr %r114, align 4
  %r149 = icmp eq i32 %r148, 46
  br i1 %r149, label %bb_if_4_47_true, label %bb_if_4_47_false

bb_if_4_47_true:                                  ; preds = %bb_if_4_43_end
  ...
  br label %bb_if_4_47_end

bb_if_4_47_false:                                 ; preds = %bb_if_4_43_end
  br label %bb_if_4_47_end

bb_if_4_47_end:                                   ; preds = %bb_if_4_47_false, %bb_if_4_47_true
  %r153 = load i32, ptr %r114, align 4
  %r154 = icmp eq i32 %r153, 44
  br i1 %r154, label %bb_if_4_51_true, label %bb_if_4_51_false

bb_if_4_51_true:                                  ; preds = %bb_if_4_47_end
  %r155 = load i32, ptr @ptr, align 4
  %r156 = getelementptr [65536 x i32], ptr @tape, i32 0, i32 %r155
  %r157 = call i32 @getch()
  store i32 %r157, ptr %r156, align 4
  br label %bb_if_4_51_end

bb_if_4_51_false:                                 ; preds = %bb_if_4_47_end
  br label %bb_if_4_51_end

bb_if_4_51_end:                                   ; preds = %bb_if_4_51_false, %bb_if_4_51_true
  %r158 = load i32, ptr %r114, align 4
  %r159 = icmp eq i32 %r158, 93
  br i1 %r159, label %bb26_55checksecond, label %bb_if_4_55_false

bb26_55checksecond:                               ; preds = %bb_if_4_51_end
  ...
  br i1 %r163, label %bb_if_4_55_true, label %bb_if_4_55_false

bb_if_4_55_true:                                  ; preds = %bb26_55checksecond
  store i32 1, ptr %r115, align 4
  br label %bb_while_6_58_cond

bb_while_6_58_cond:                               ; preds = %bb_if_8_65_end, %bb_if_4_55_true
  %r164 = load i32, ptr %r115, align 4
  %r165 = icmp sgt i32 %r164, 0
  br i1 %r165, label %bb_while_6_58_whilestms, label %bb_while_6_58_bre

bb_while_6_58_whilestms:                          ; preds = %bb_while_6_58_cond
  ...
  br i1 %r172, label %bb_if_8_61_true, label %bb_if_8_61_false

bb_if_8_61_true:                                  ; preds = %bb_while_6_58_whilestms
  %r173 = load i32, ptr %r115, align 4
  %r174 = sub i32 %r173, 1
  store i32 %r174, ptr %r115, align 4
  br label %bb_if_8_61_end

bb_if_8_61_false:                                 ; preds = %bb_while_6_58_whilestms
  br label %bb_if_8_61_end

bb_if_8_61_end:                                   ; preds = %bb_if_8_61_false, %bb_if_8_61_true
  %r175 = load i32, ptr %r114, align 4
  %r176 = icmp eq i32 %r175, 93
  br i1 %r176, label %bb_if_8_65_true, label %bb_if_8_65_false

bb_if_8_65_true:                                  ; preds = %bb_if_8_61_end
  %r177 = load i32, ptr %r115, align 4
  %r178 = add i32 %r177, 1
  store i32 %r178, ptr %r115, align 4
  br label %bb_if_8_65_end

bb_if_8_65_false:                                 ; preds = %bb_if_8_61_end
  br label %bb_if_8_65_end

bb_if_8_65_end:                                   ; preds = %bb_if_8_65_false, %bb_if_8_65_true
  br label %bb_while_6_58_cond

bb_while_6_58_bre:                                ; preds = %bb_while_6_58_cond
  br label %bb_if_4_55_end

bb_if_4_55_false:                                 ; preds = %bb26_55checksecond, %bb_if_4_51_end
  br label %bb_if_4_55_end

bb_if_4_55_end:                                   ; preds = %bb_if_4_55_false, %bb_while_6_58_bre
  %r179 = load i32, ptr %r116, align 4
  %r180 = add i32 %r179, 1
  store i32 %r180, ptr %r116, align 4
  br label %bb_while_2_29_cond

bb_while_2_29_bre:                                ; preds = %bb_while_2_29_cond
  ret void
}

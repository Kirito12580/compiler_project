...
bb1:                                              ; preds = %bb2
  ...
  br label %bb_while_4_8_cond

bb_while_4_8_cond:                                ; preds = %bb_while_4_8_whilestms, %bb1
  %r103 = load i32, ptr %r100, align 4
  %r104 = icmp slt i32 %r103, 10
  br i1 %r104, label %bb_while_4_8_whilestms, label %bb_while_4_8_bre

bb_while_4_8_whilestms:                           ; preds = %bb_while_4_8_cond
...
bb_while_4_8_bre:                                 ; preds = %bb_while_4_8_cond
  ...
  br label %bb_while_4_28_cond

bb_while_4_28_cond:                               ; preds = %bb_if_8_30_end, %bb_while_4_8_bre
  %r125 = load i32, ptr %r100, align 4
  %r126 = icmp slt i32 %r125, 10
  br i1 %r126, label %bb18_28checksecond, label %bb_while_4_28_bre

bb18_28checksecond:                               ; preds = %bb_while_4_28_cond
  %r127 = load i32, ptr %r123, align 4
  %r128 = icmp eq i32 %r127, 0
  br i1 %r128, label %bb_while_4_28_whilestms, label %bb_while_4_28_bre

bb_while_4_28_whilestms:                          ; preds = %bb18_28checksecond
  ...
  br i1 %r133, label %bb_if_8_30_true, label %bb_if_8_30_false

bb_if_8_30_true:                                  ; preds = %bb_while_4_28_whilestms
  store i32 1, ptr %r123, align 4
  %r134 = load i32, ptr %r100, align 4
  store i32 %r134, ptr %r124, align 4
  br label %bb_if_8_30_end

bb_if_8_30_false:                                 ; preds = %bb_while_4_28_whilestms
  br label %bb_if_8_30_end

bb_if_8_30_end:                                   ; preds = %bb_if_8_30_false, %bb_if_8_30_true
  %r135 = load i32, ptr %r100, align 4
  %r136 = add i32 %r135, 1
  store i32 %r136, ptr %r100, align 4
  br label %bb_while_4_28_cond

bb_while_4_28_bre:                                ; preds = %bb18_28checksecond, %bb_while_4_28_cond
  %r137 = load i32, ptr %r123, align 4
  %r138 = icmp eq i32 %r137, 1
  br i1 %r138, label %bb_if_4_39_true, label %bb_if_4_39_false

bb_if_4_39_true:                                  ; preds = %bb_while_4_28_bre
  %r139 = load i32, ptr %r124, align 4
  call void @putint(i32 %r139)
  br label %bb_if_4_39_end

bb_if_4_39_false:                                 ; preds = %bb_while_4_28_bre

...
bb_while_4_8_bre:                                 ; preds = %bb_while_4_8_cond
  ...
  br label %bb_while_4_23_cond

bb_while_4_23_cond:                               ; preds = %bb_if_8_26_end, %bb_while_4_8_bre
  ...
  br i1 %r127, label %bb23_23checksecond, label %bb_while_4_23_bre

bb23_23checksecond:                               ; preds = %bb_while_4_23_cond
  %r128 = load i32, ptr %r113, align 4
  %r129 = load i32, ptr %r112, align 4
  %r130 = icmp slt i32 %r128, %r129
  br i1 %r130, label %bb_while_4_23_whilestms, label %bb_while_4_23_bre

bb_while_4_23_whilestms:                          ; preds = %bb23_23checksecond
  ...
  br i1 %r139, label %bb_if_8_26_true, label %bb_if_8_26_false

bb_if_8_26_true:                                  ; preds = %bb_while_4_23_whilestms
  %r140 = load i32, ptr %r114, align 4
  %r141 = sub i32 %r140, 1
  store i32 %r141, ptr %r112, align 4
  br label %bb_if_8_26_end

bb_if_8_26_false:                                 ; preds = %bb_while_4_23_whilestms
  %r142 = load i32, ptr %r114, align 4
  %r143 = add i32 %r142, 1
  store i32 %r143, ptr %r113, align 4
  br label %bb_if_8_26_end

bb_if_8_26_end:                                   ; preds = %bb_if_8_26_false, %bb_if_8_26_true
  br label %bb_while_4_23_cond

bb_while_4_23_bre:                                ; preds = %bb23_23checksecond, %bb_while_4_23_cond
  ...
  br i1 %r148, label %bb_if_4_36_true, label %bb_if_4_36_false

bb_if_4_36_true:                                  ; preds = %bb_while_4_23_bre
  %r149 = load i32, ptr %r111, align 4
  call void @putint(i32 %r149)
  br label %bb_if_4_36_end

bb_if_4_36_false:                                 ; preds = %bb_while_4_23_bre
  store i32 0, ptr %r111, align 4
  %r150 = load i32, ptr %r111, align 4
  call void @putint(i32 %r150)
  br label %bb_if_4_36_end

bb_if_4_36_end:                                   ; preds = %bb_if_4_36_false, %bb_if_4_36_true

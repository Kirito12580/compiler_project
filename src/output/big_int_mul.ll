...
bb_while_4_20_cond:                               ; preds = %bb_while_4_20_whilestms, %bb1
  %r175 = load i32, ptr %r100, align 4
  %r176 = load i32, ptr %r147, align 4
  %r177 = icmp slt i32 %r175, %r176
  br i1 %r177, label %bb_while_4_20_whilestms, label %bb_while_4_20_bre
...
bb_while_4_26_cond:                               ; preds = %bb_while_4_26_whilestms, %bb_while_4_20_bre
  %r185 = load i32, ptr %r100, align 4
  %r186 = load i32, ptr %r149, align 4
  %r187 = icmp slt i32 %r185, %r186
  br i1 %r187, label %bb_while_4_26_whilestms, label %bb_while_4_26_bre
...
bb_while_4_26_bre:                                ; preds = %bb_while_4_26_cond
  ...
  store i32 0, ptr %r100, align 4
  br label %bb_while_4_34_cond

bb_while_4_34_cond:                               ; preds = %bb_while_4_34_whilestms, %bb_while_4_26_bre
  %r199 = load i32, ptr %r100, align 4
  %r200 = load i32, ptr %r103, align 4
  %r201 = icmp sle i32 %r199, %r200
  br i1 %r201, label %bb_while_4_34_whilestms, label %bb_while_4_34_bre

bb_while_4_34_whilestms:                          ; preds = %bb_while_4_34_cond
...
bb_while_4_34_bre:                                ; preds = %bb_while_4_34_cond
...
bb_while_4_42_cond:                               ; preds = %bb_while_8_45_bre, %bb_while_4_34_bre
  %r208 = load i32, ptr %r100, align 4
  %r209 = sub i32 0, 1
  %r210 = icmp sgt i32 %r208, %r209
  br i1 %r210, label %bb_while_4_42_whilestms, label %bb_while_4_42_bre
...
bb_while_4_42_whilestms:                          ; preds = %bb_while_4_42_cond
  ...
  br label %bb_while_8_45_cond

bb_while_8_45_cond:                               ; preds = %bb_if_12_47_end, %bb_while_4_42_whilestms
  %r216 = load i32, ptr %r101, align 4
  %r217 = sub i32 0, 1
  %r218 = icmp sgt i32 %r216, %r217
  br i1 %r218, label %bb_while_8_45_whilestms, label %bb_while_8_45_bre

bb_while_8_45_whilestms:                          ; preds = %bb_while_8_45_cond
  ...
  br i1 %r229, label %bb_if_12_47_true, label %bb_if_12_47_false

bb_if_12_47_true:                                 ; preds = %bb_while_8_45_whilestms
  ...
  br label %bb_if_12_47_end

bb_if_12_47_false:                                ; preds = %bb_while_8_45_whilestms
...
bb_if_12_47_end:                                  ; preds = %bb_if_12_47_false, %bb_if_12_47_true
...
bb_while_8_45_bre:                                ; preds = %bb_while_8_45_cond
...
bb_while_4_42_bre:                                ; preds = %bb_while_4_42_cond
  ...
  br i1 %r259, label %bb_if_4_62_true, label %bb_if_4_62_false

bb_if_4_62_true:                                  ; preds = %bb_while_4_42_bre
  %r260 = getelementptr [40 x i32], ptr %r153, i32 0, i32 0
  %r261 = load i32, ptr %r260, align 4
  call void @putint(i32 %r261)
  br label %bb_if_4_62_end

bb_if_4_62_false:                                 ; preds = %bb_while_4_42_bre
  br label %bb_if_4_62_end

bb_if_4_62_end:                                   ; preds = %bb_if_4_62_false, %bb_if_4_62_true
  store i32 1, ptr %r100, align 4
  br label %bb_while_4_67_cond

bb_while_4_67_cond:                               ; preds = %bb_while_4_67_whilestms, %bb_if_4_62_end
  ...
  br i1 %r267, label %bb_while_4_67_whilestms, label %bb_while_4_67_bre

bb_while_4_67_whilestms:                          ; preds = %bb_while_4_67_cond
...
bb_while_4_67_bre:                                ; preds = %bb_while_4_67_cond

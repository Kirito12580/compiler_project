...
bb2:                                              ; preds = %bb6
  ...
  br label %bb_while_4_14_cond

bb_while_4_14_cond:                               ; preds = %bb_if_8_18_end, %bb2
  %r128 = load i32, ptr %r124, align 4
  %r129 = load i32, ptr %r121, align 4
  %r130 = add i32 %r129, 1
  %r131 = icmp slt i32 %r128, %r130
  br i1 %r131, label %bb_while_4_14_whilestms, label %bb_while_4_14_bre

bb_while_4_14_whilestms:                          ; preds = %bb_while_4_14_cond
  ...
  br i1 %r137, label %bb25_16checksecond, label %bb_if_8_16_false

bb25_16checksecond:                               ; preds = %bb_while_4_14_whilestms
  ...
  br i1 %r144, label %bb_if_8_16_true, label %bb_if_8_16_false

bb_if_8_16_true:                                  ; preds = %bb25_16checksecond
  %r145 = load i32, ptr %r124, align 4
  %r146 = add i32 %r145, 1
  store i32 %r146, ptr %r124, align 4
  br label %bb_if_8_16_end

bb_if_8_16_false:                                 ; preds = %bb25_16checksecond, %bb_while_4_14_whilestms
  br label %bb_if_8_16_end

bb_if_8_16_end:                                   ; preds = %bb_if_8_16_false, %bb_if_8_16_true
  ...
  br i1 %r153, label %bb_if_8_18_true, label %bb_if_8_18_false

bb_if_8_18_true:                                  ; preds = %bb_if_8_16_end
  ret i32 0

bb_if_8_18_false:                                 ; preds = %bb_if_8_16_end
  ...
  br label %bb_if_8_18_end

bb_if_8_18_end:                                   ; preds = %bb_if_8_18_false
  br label %bb_while_4_14_cond

bb_while_4_14_bre:                                ; preds = %bb_while_4_14_cond
  ret i32 0
}
...
bb3:                                              ; preds = %bb7
  ...
  br label %bb_while_4_32_cond

bb_while_4_32_cond:                               ; preds = %bb_while_4_32_whilestms, %bb3
  %r169 = load i32, ptr %r164, align 4
  %r170 = sub i32 0, 1
  %r171 = icmp sgt i32 %r169, %r170
  br i1 %r171, label %bb_while_4_32_whilestms, label %bb_while_4_32_bre

bb_while_4_32_whilestms:                          ; preds = %bb_while_4_32_cond
...
bb_while_4_32_bre:                                ; preds = %bb_while_4_32_cond
  %r179 = load i32, ptr %r163, align 4
  %r180 = sub i32 %r179, 1
  store i32 %r180, ptr %r164, align 4
  br label %bb_while_4_38_cond

bb_while_4_38_cond:                               ; preds = %bb_while_4_38_whilestms, %bb_while_4_32_bre
  %r181 = load i32, ptr %r164, align 4
  %r182 = icmp sgt i32 %r181, 0
  br i1 %r182, label %bb_while_4_38_whilestms, label %bb_while_4_38_bre
...
bb4:                                              ; preds = %bb8
  ...
  br label %bb_while_4_57_cond

bb_while_4_57_cond:                               ; preds = %bb_while_4_57_whilestms, %bb4
  %r209 = load i32, ptr %r205, align 4
  %r210 = load i32, ptr @n, align 4
  %r211 = icmp slt i32 %r209, %r210
  br i1 %r211, label %bb_while_4_57_whilestms, label %bb_while_4_57_bre

bb_while_4_57_whilestms:                          ; preds = %bb_while_4_57_cond
...
bb_while_4_57_bre:                                ; preds = %bb_while_4_57_cond
  ret i32 0
}

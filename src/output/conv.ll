...
bb1:                                              ; preds = %bb8
  ...
  br label %bb_while_4_3_cond

bb_while_4_3_cond:                                ; preds = %bb_while_4_3_whilestms, %bb1
  %r102 = load i32, ptr %r101, align 4
  %r103 = load i32, ptr @max, align 4
  %r104 = icmp sgt i32 %r102, %r103
  br i1 %r104, label %bb_while_4_3_whilestms, label %bb_while_4_3_bre

bb_while_4_3_whilestms:                           ; preds = %bb_while_4_3_cond
...
bb_while_4_3_bre:                                 ; preds = %bb_while_4_3_cond
  br label %bb_while_4_4_cond

bb_while_4_4_cond:                                ; preds = %bb_while_4_4_whilestms, %bb_while_4_3_bre
  %r108 = load i32, ptr %r101, align 4
  %r109 = icmp slt i32 %r108, 0
  br i1 %r109, label %bb_while_4_4_whilestms, label %bb_while_4_4_bre

bb_while_4_4_whilestms:                           ; preds = %bb_while_4_4_cond
...
bb_while_4_4_bre:                                 ; preds = %bb_while_4_4_cond
...
bb3:                                              ; preds = %bb10
  ...
  br i1 %r132, label %bb_if_4_12_true, label %bb_if_4_12_false

bb_if_4_12_true:                                  ; preds = %bb3
...
bb_if_4_12_false:                                 ; preds = %bb3
  br label %bb_if_4_12_end

bb_if_4_12_end:                                   ; preds = %bb_if_4_12_false
  %r137 = load i32, ptr %r126, align 4
  %r138 = icmp eq i32 %r137, 1
  br i1 %r138, label %bb_if_4_15_true, label %bb_if_4_15_false

bb_if_4_15_true:                                  ; preds = %bb_if_4_12_end
  store i32 0, ptr %r139, align 4
  store i32 1, ptr %r140, align 4
  br label %bb_while_8_19_cond

bb_while_8_19_cond:                               ; preds = %bb_if_12_20_end, %bb_if_4_15_true
  %r141 = load i32, ptr %r140, align 4
  %r142 = load i32, ptr @max, align 4
  %r143 = icmp slt i32 %r141, %r142
  br i1 %r143, label %bb_while_8_19_whilestms, label %bb_while_8_19_bre

bb_while_8_19_whilestms:                          ; preds = %bb_while_8_19_cond
  ...
  br i1 %r152, label %bb_if_12_20_true, label %bb_if_12_20_false

bb_if_12_20_true:                                 ; preds = %bb_while_8_19_whilestms
  %r153 = load i32, ptr %r139, align 4
  %r154 = mul i32 %r153, 2
  store i32 %r154, ptr %r139, align 4
  br label %bb_if_12_20_end

bb_if_12_20_false:                                ; preds = %bb_while_8_19_whilestms
...
bb_if_12_20_end:                                  ; preds = %bb_if_12_20_false, %bb_if_12_20_true
  %r158 = load i32, ptr %r140, align 4
  %r159 = mul i32 %r158, 2
  store i32 %r159, ptr %r140, align 4
  br label %bb_while_8_19_cond

bb_while_8_19_bre:                                ; preds = %bb_while_8_19_cond
  %r160 = load i32, ptr %r139, align 4
  ret i32 %r160

bb_if_4_15_false:                                 ; preds = %bb_if_4_12_end
  br label %bb_if_4_15_end

bb_if_4_15_end:                                   ; preds = %bb_if_4_15_false
  %r161 = load i32, ptr %r126, align 4
  %r162 = icmp eq i32 %r161, 2
  br i1 %r162, label %bb_if_4_30_true, label %bb_if_4_30_false

bb_if_4_30_true:                                  ; preds = %bb_if_4_15_end
  %r163 = load i32, ptr %r128, align 4
  %r164 = load i32, ptr %r130, align 4
  %r165 = icmp sgt i32 %r163, %r164
  br i1 %r165, label %bb_if_8_31_true, label %bb_if_8_31_false

bb_if_8_31_true:                                  ; preds = %bb_if_4_30_true
  %r166 = load i32, ptr %r128, align 4
  ret i32 %r166

bb_if_8_31_false:                                 ; preds = %bb_if_4_30_true
  %r167 = load i32, ptr %r130, align 4
  ret i32 %r167

bb_if_8_31_end:                                   ; No predecessors!
  br label %bb_if_4_30_end

bb_if_4_30_false:                                 ; preds = %bb_if_4_15_end
  br label %bb_if_4_30_end

bb_if_4_30_end:                                   ; preds = %bb_if_4_30_false, %bb_if_8_31_end
  %r168 = load i32, ptr %r126, align 4
  %r169 = icmp eq i32 %r168, 3
  br i1 %r169, label %bb_if_4_34_true, label %bb_if_4_34_false

bb_if_4_34_true:                                  ; preds = %bb_if_4_30_end
  store i32 0, ptr %r170, align 4
  store i32 1, ptr %r171, align 4
  br label %bb_while_8_39_cond

bb_while_8_39_cond:                               ; preds = %bb_if_12_40_end, %bb_if_4_34_true
  %r172 = load i32, ptr %r171, align 4
  %r173 = load i32, ptr @max, align 4
  %r174 = icmp slt i32 %r172, %r173
  br i1 %r174, label %bb_while_8_39_whilestms, label %bb_while_8_39_bre

bb_while_8_39_whilestms:                          ; preds = %bb_while_8_39_cond
  ...
  br i1 %r179, label %bb_if_12_40_true, label %bb36_40checksecond

bb36_40checksecond:                               ; preds = %bb_while_8_39_whilestms
  ...
  br i1 %r184, label %bb_if_12_40_true, label %bb_if_12_40_false

bb_if_12_40_true:                                 ; preds = %bb36_40checksecond, %bb_while_8_39_whilestms
  %r185 = load i32, ptr %r170, align 4
  %r186 = mul i32 %r185, 2
  %r187 = add i32 %r186, 1
  store i32 %r187, ptr %r170, align 4
  br label %bb_if_12_40_end

bb_if_12_40_false:                                ; preds = %bb36_40checksecond
  %r188 = load i32, ptr %r170, align 4
  %r189 = mul i32 %r188, 2
  store i32 %r189, ptr %r170, align 4
  br label %bb_if_12_40_end

bb_if_12_40_end:                                  ; preds = %bb_if_12_40_false, %bb_if_12_40_true
  %r190 = load i32, ptr %r171, align 4
  %r191 = mul i32 %r190, 2
  store i32 %r191, ptr %r171, align 4
  br label %bb_while_8_39_cond

bb_while_8_39_bre:                                ; preds = %bb_while_8_39_cond
  %r192 = load i32, ptr %r170, align 4
  ret i32 %r192

bb_if_4_34_false:                                 ; preds = %bb_if_4_30_end
  br label %bb_if_4_34_end

bb_if_4_34_end:                                   ; preds = %bb_if_4_34_false
  %r193 = load i32, ptr %r126, align 4
  %r194 = icmp eq i32 %r193, 4
  br i1 %r194, label %bb_if_4_50_true, label %bb_if_4_50_false

bb_if_4_50_true:                                  ; preds = %bb_if_4_34_end
  store i32 0, ptr %r195, align 4
  store i32 1, ptr %r196, align 4
  br label %bb_while_8_54_cond

bb_while_8_54_cond:                               ; preds = %bb_if_12_55_end, %bb_if_4_50_true
  %r197 = load i32, ptr %r196, align 4
  %r198 = load i32, ptr @max, align 4
  %r199 = icmp slt i32 %r197, %r198
  br i1 %r199, label %bb_while_8_54_whilestms, label %bb_while_8_54_bre

bb_while_8_54_whilestms:                          ; preds = %bb_while_8_54_cond
  ...
  br i1 %r204, label %bb36_55checksecond, label %bb_if_12_55_false

bb36_55checksecond:                               ; preds = %bb_while_8_54_whilestms
  ...
  br i1 %r209, label %bb_if_12_55_true, label %bb_if_12_55_false

bb_if_12_55_true:                                 ; preds = %bb36_55checksecond
  %r210 = load i32, ptr %r195, align 4
  %r211 = mul i32 %r210, 2
  %r212 = add i32 %r211, 1
  store i32 %r212, ptr %r195, align 4
  br label %bb_if_12_55_end

bb_if_12_55_false:                                ; preds = %bb36_55checksecond, %bb_while_8_54_whilestms
  %r213 = load i32, ptr %r195, align 4
  %r214 = mul i32 %r213, 2
  store i32 %r214, ptr %r195, align 4
  br label %bb_if_12_55_end

bb_if_12_55_end:                                  ; preds = %bb_if_12_55_false, %bb_if_12_55_true
  %r215 = load i32, ptr %r196, align 4
  %r216 = mul i32 %r215, 2
  store i32 %r216, ptr %r196, align 4
  br label %bb_while_8_54_cond

bb_while_8_54_bre:                                ; preds = %bb_while_8_54_cond
  %r217 = load i32, ptr %r195, align 4
  ret i32 %r217

bb_if_4_50_false:                                 ; preds = %bb_if_4_34_end
  br label %bb_if_4_50_end

bb_if_4_50_end:                                   ; preds = %bb_if_4_50_false
  ret i32 0
}
...
bb4:                                              ; preds = %bb11
  ...
  br i1 %r228, label %bb_if_4_69_true, label %bb19_69checksecond

bb19_69checksecond:                               ; preds = %bb4
  %r229 = load i32, ptr %r226, align 4
  %r230 = icmp slt i32 %r229, 0
  br i1 %r230, label %bb_if_4_69_true, label %bb30_69checksecond

bb30_69checksecond:                               ; preds = %bb19_69checksecond
  %r231 = load i32, ptr %r224, align 4
  %r232 = load i32, ptr %r220, align 4
  %r233 = icmp sge i32 %r231, %r232
  br i1 %r233, label %bb_if_4_69_true, label %bb41_69checksecond

bb41_69checksecond:                               ; preds = %bb30_69checksecond
  %r234 = load i32, ptr %r226, align 4
  %r235 = load i32, ptr %r222, align 4
  %r236 = icmp sge i32 %r234, %r235
  br i1 %r236, label %bb_if_4_69_true, label %bb_if_4_69_false

bb_if_4_69_true:                                  ; preds = %bb41_69checksecond, %bb30_69checksecond, %bb19_69checksecond, %bb4
  ret i32 0

bb_if_4_69_false:                                 ; preds = %bb41_69checksecond
  br label %bb_if_4_69_end

bb_if_4_69_end:                                   ; preds = %bb_if_4_69_false
...
bb5:                                              ; preds = %bb12
  ...
  br label %bb_while_4_81_cond

bb_while_4_81_cond:                               ; preds = %bb_if_8_102_end, %bb5
  %r262 = load i32, ptr %r261, align 4
  %r263 = load i32, ptr %r261, align 4
  %r264 = icmp eq i32 %r262, %r263
  br i1 %r264, label %bb_while_4_81_whilestms, label %bb_while_4_81_bre

bb_while_4_81_whilestms:                          ; preds = %bb_while_4_81_cond
  store i32 0, ptr %r257, align 4
  br label %bb_while_8_83_cond

bb_while_8_83_cond:                               ; preds = %bb_if_12_99_end, %bb_while_4_81_whilestms
  %r265 = load i32, ptr %r261, align 4
  %r266 = load i32, ptr %r261, align 4
  %r267 = icmp eq i32 %r265, %r266
  br i1 %r267, label %bb_while_8_83_whilestms, label %bb_while_8_83_bre

bb_while_8_83_whilestms:                          ; preds = %bb_while_8_83_cond
  ...
  br label %bb_while_12_86_cond

bb_while_12_86_cond:                              ; preds = %bb_if_16_94_end, %bb_while_8_83_whilestms
  %r272 = load i32, ptr %r261, align 4
  %r273 = load i32, ptr %r261, align 4
  %r274 = icmp eq i32 %r272, %r273
  br i1 %r274, label %bb_while_12_86_whilestms, label %bb_while_12_86_bre

bb_while_12_86_whilestms:                         ; preds = %bb_while_12_86_cond
  ...
  br label %bb_while_16_88_cond

bb_while_16_88_cond:                              ; preds = %bb_if_20_91_end, %bb_while_12_86_whilestms
  %r279 = load i32, ptr %r261, align 4
  %r280 = load i32, ptr %r261, align 4
  %r281 = icmp eq i32 %r279, %r280
  br i1 %r281, label %bb_while_16_88_whilestms, label %bb_while_16_88_bre

bb_while_16_88_whilestms:                         ; preds = %bb_while_16_88_cond
  ...
  br i1 %r297, label %bb_if_20_91_true, label %bb_if_20_91_false

bb_if_20_91_true:                                 ; preds = %bb_while_16_88_whilestms
  br label %bb_while_16_88_bre

bb_if_20_91_false:                                ; preds = %bb_while_16_88_whilestms
  br label %bb_if_20_91_end

bb_if_20_91_end:                                  ; preds = %bb_if_20_91_false
  br label %bb_while_16_88_cond

bb_while_16_88_bre:                               ; preds = %bb_if_20_91_true, %bb_while_16_88_cond
  ...
  br i1 %r305, label %bb_if_16_94_true, label %bb_if_16_94_false

bb_if_16_94_true:                                 ; preds = %bb_while_16_88_bre
  br label %bb_while_12_86_bre

bb_if_16_94_false:                                ; preds = %bb_while_16_88_bre
  br label %bb_if_16_94_end

bb_if_16_94_end:                                  ; preds = %bb_if_16_94_false
  br label %bb_while_12_86_cond

bb_while_12_86_bre:                               ; preds = %bb_if_16_94_true, %bb_while_12_86_cond
  ...
  br i1 %r319, label %bb_if_12_99_true, label %bb_if_12_99_false

bb_if_12_99_true:                                 ; preds = %bb_while_12_86_bre
  br label %bb_while_8_83_bre

bb_if_12_99_false:                                ; preds = %bb_while_12_86_bre
  br label %bb_if_12_99_end

bb_if_12_99_end:                                  ; preds = %bb_if_12_99_false
  br label %bb_while_8_83_cond

bb_while_8_83_bre:                                ; preds = %bb_if_12_99_true, %bb_while_8_83_cond
  ...
  br i1 %r324, label %bb_if_8_102_true, label %bb_if_8_102_false

bb_if_8_102_true:                                 ; preds = %bb_while_8_83_bre
  br label %bb_while_4_81_bre

bb_if_8_102_false:                                ; preds = %bb_while_8_83_bre
  br label %bb_if_8_102_end

bb_if_8_102_end:                                  ; preds = %bb_if_8_102_false
  br label %bb_while_4_81_cond

bb_while_4_81_bre:                                ; preds = %bb_if_8_102_true, %bb_while_4_81_cond
  ret i32 0
}
...
bb6:                                              ; preds = %bb13
  ...
  br label %bb_while_4_113_cond

bb_while_4_113_cond:                              ; preds = %bb_while_4_113_whilestms, %bb6
  %r330 = load i32, ptr %r329, align 4
  %r331 = load i32, ptr %r328, align 4
  %r332 = icmp slt i32 %r330, %r331
  br i1 %r332, label %bb_while_4_113_whilestms, label %bb_while_4_113_bre

bb_while_4_113_whilestms:                         ; preds = %bb_while_4_113_cond
...
bb_while_4_113_bre:                               ; preds = %bb_while_4_113_cond
  ret void
}
...
bb7:                                              ; preds = %bb14
  ...
  br label %bb_while_4_126_cond

bb_while_4_126_cond:                              ; preds = %bb_while_4_126_whilestms, %bb7
  %r349 = load i32, ptr %r348, align 4
  %r350 = load i32, ptr %r346, align 4
  %r351 = icmp slt i32 %r349, %r350
  br i1 %r351, label %bb_while_4_126_whilestms, label %bb_while_4_126_bre

bb_while_4_126_whilestms:                         ; preds = %bb_while_4_126_cond
...
bb_while_4_126_bre:                               ; preds = %bb_while_4_126_cond
  %r357 = call i32 @getint()
  store i32 %r357, ptr %r346, align 4
  store i32 0, ptr %r348, align 4
  br label %bb_while_4_132_cond

bb_while_4_132_cond:                              ; preds = %bb_while_4_132_whilestms, %bb_while_4_126_bre
  %r358 = load i32, ptr %r348, align 4
  %r359 = load i32, ptr %r346, align 4
  %r360 = icmp slt i32 %r358, %r359
  br i1 %r360, label %bb_while_4_132_whilestms, label %bb_while_4_132_bre

bb_while_4_132_whilestms:                         ; preds = %bb_while_4_132_cond
...
bb_while_4_132_bre:                               ; preds = %bb_while_4_132_cond
  ...
  br label %bb_while_4_140_cond

bb_while_4_140_cond:                              ; preds = %bb_while_4_140_whilestms, %bb_while_4_132_bre
  %r369 = load i32, ptr %r368, align 4
  %r370 = load i32, ptr %r366, align 4
  %r371 = icmp slt i32 %r369, %r370
  br i1 %r371, label %bb_while_4_140_whilestms, label %bb_while_4_140_bre

bb_while_4_140_whilestms:                         ; preds = %bb_while_4_140_cond
...
bb_while_4_140_bre:                               ; preds = %bb_while_4_140_cond

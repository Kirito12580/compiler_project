...
bb1:                                              ; preds = %bb5
  ...
  br label %bb_while_4_7_cond

bb_while_4_7_cond:                                ; preds = %bb_if_8_9_end, %bb_if_8_9_true, %bb1
  %r102 = icmp sgt i32 1, 0
  br i1 %r102, label %bb_while_4_7_whilestms, label %bb_while_4_7_bre

bb_while_4_7_whilestms:                           ; preds = %bb_while_4_7_cond
  %r103 = call i32 @getch()
  ...
  br i1 %r107, label %bb_if_8_9_true, label %bb21_9checksecond

bb21_9checksecond:                                ; preds = %bb_while_4_7_whilestms
  %r108 = load i32, ptr %r101, align 4
  %r109 = icmp sgt i32 %r108, 9
  br i1 %r109, label %bb_if_8_9_true, label %bb_if_8_9_false

bb_if_8_9_true:                                   ; preds = %bb21_9checksecond, %bb_while_4_7_whilestms
  br label %bb_while_4_7_cond

bb_if_8_9_false:                                  ; preds = %bb21_9checksecond
  br label %bb_while_4_7_bre

bb_if_8_9_end:                                    ; No predecessors!
  br label %bb_while_4_7_cond

bb_while_4_7_bre:                                 ; preds = %bb_if_8_9_false, %bb_while_4_7_cond
  %r110 = load i32, ptr %r101, align 4
  store i32 %r110, ptr %r100, align 4
  br label %bb_while_4_17_cond

bb_while_4_17_cond:                               ; preds = %bb_if_8_19_end, %bb_while_4_7_bre
  %r111 = icmp sgt i32 1, 0
  br i1 %r111, label %bb_while_4_17_whilestms, label %bb_while_4_17_bre

bb_while_4_17_whilestms:                          ; preds = %bb_while_4_17_cond
  %r112 = call i32 @getch()
  ...
  br i1 %r116, label %bb22_19checksecond, label %bb_if_8_19_false

bb22_19checksecond:                               ; preds = %bb_while_4_17_whilestms
  %r117 = load i32, ptr %r101, align 4
  %r118 = icmp sle i32 %r117, 9
  br i1 %r118, label %bb_if_8_19_true, label %bb_if_8_19_false

bb_if_8_19_true:                                  ; preds = %bb22_19checksecond
  ...
  br label %bb_if_8_19_end

bb_if_8_19_false:                                 ; preds = %bb22_19checksecond, %bb_while_4_17_whilestms
  br label %bb_while_4_17_bre

bb_if_8_19_end:                                   ; preds = %bb_if_8_19_true
  br label %bb_while_4_17_cond

bb_while_4_17_bre:                                ; preds = %bb_if_8_19_false, %bb_while_4_17_cond
...
bb3:                                              ; preds = %bb7
  ...
  br label %bb_while_4_38_cond

bb_while_4_38_cond:                               ; preds = %bb_while_4_38_whilestms, %bb3
  %r139 = load i32, ptr %r136, align 4
  %r140 = icmp sgt i32 %r139, 0
  br i1 %r140, label %bb_while_4_38_whilestms, label %bb_while_4_38_bre

bb_while_4_38_whilestms:                          ; preds = %bb_while_4_38_cond
...
bb_while_4_38_bre:                                ; preds = %bb_while_4_38_cond
  br label %bb_while_4_43_cond

bb_while_4_43_cond:                               ; preds = %bb_while_4_43_whilestms, %bb_while_4_38_bre
  %r151 = load i32, ptr %r138, align 4
  %r152 = icmp sgt i32 %r151, 0
  br i1 %r152, label %bb_while_4_43_whilestms, label %bb_while_4_43_bre
...
bb4:                                              ; preds = %bb8
  ...
  br label %bb_while_4_52_cond

bb_while_4_52_cond:                               ; preds = %bb_while_4_52_whilestms, %bb4
  %r160 = load i32, ptr %r158, align 4
  %r161 = icmp sgt i32 %r160, 0
  br i1 %r161, label %bb_while_4_52_whilestms, label %bb_while_4_52_bre

bb_while_4_52_whilestms:                          ; preds = %bb_while_4_52_cond
...
bb_while_4_52_bre:                                ; preds = %bb_while_4_52_cond
  ret i32 0
}

...
bb1:                                              ; preds = %bb2
  ...
  br label %bb_while_4_9_cond

bb_while_4_9_cond:                                ; preds = %bb_while_4_9_whilestms, %bb1
  %r102 = load i32, ptr %r100, align 4
  %r103 = icmp slt i32 %r102, 10
  br i1 %r103, label %bb_while_4_9_whilestms, label %bb_while_4_9_bre

bb_while_4_9_whilestms:                           ; preds = %bb_while_4_9_cond
...
bb_while_4_9_bre:                                 ; preds = %bb_while_4_9_cond
  store i32 0, ptr %r100, align 4
  br label %bb_while_4_15_cond

bb_while_4_15_cond:                               ; preds = %bb_while_4_15_whilestms, %bb_while_4_9_bre
  %r109 = load i32, ptr %r100, align 4
  %r110 = icmp slt i32 %r109, 10
  br i1 %r110, label %bb_while_4_15_whilestms, label %bb_while_4_15_bre

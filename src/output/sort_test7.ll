...
bb1:                                              ; preds = %bb4
  ...
  br label %bb_while_4_15_cond

bb_while_4_15_cond:                               ; preds = %bb_while_4_15_whilestms, %bb1
  %r121 = load i32, ptr %r118, align 4
  %r122 = load i32, ptr %r107, align 4
  %r123 = icmp slt i32 %r121, %r122
  br i1 %r123, label %bb_while_4_15_whilestms, label %bb_while_4_15_bre

bb_while_4_15_whilestms:                          ; preds = %bb_while_4_15_cond
...
bb_while_4_15_bre:                                ; preds = %bb_while_4_15_cond
  br label %bb_while_4_20_cond

bb_while_4_20_cond:                               ; preds = %bb_while_4_20_whilestms, %bb_while_4_15_bre
  %r134 = load i32, ptr %r119, align 4
  %r135 = load i32, ptr %r112, align 4
  %r136 = icmp slt i32 %r134, %r135
  br i1 %r136, label %bb_while_4_20_whilestms, label %bb_while_4_20_bre

bb_while_4_20_whilestms:                          ; preds = %bb_while_4_20_cond
...
bb_while_4_20_bre:                                ; preds = %bb_while_4_20_cond
  store i32 0, ptr %r118, align 4
  store i32 0, ptr %r119, align 4
  %r149 = load i32, ptr %r102, align 4
  store i32 %r149, ptr %r148, align 4
  br label %bb_while_4_29_cond

bb_while_4_29_cond:                               ; preds = %bb_if_8_31_end, %bb_while_4_20_bre
  %r150 = load i32, ptr %r118, align 4
  %r151 = load i32, ptr %r107, align 4
  %r152 = icmp ne i32 %r150, %r151
  br i1 %r152, label %bb21_29checksecond, label %bb_while_4_29_bre

bb21_29checksecond:                               ; preds = %bb_while_4_29_cond
  %r153 = load i32, ptr %r119, align 4
  %r154 = load i32, ptr %r112, align 4
  %r155 = icmp ne i32 %r153, %r154
  br i1 %r155, label %bb_while_4_29_whilestms, label %bb_while_4_29_bre

bb_while_4_29_whilestms:                          ; preds = %bb21_29checksecond
  ...
  br i1 %r163, label %bb_if_8_31_true, label %bb_if_8_31_false

bb_if_8_31_true:                                  ; preds = %bb_while_4_29_whilestms
  ...
  br label %bb_if_8_31_end

bb_if_8_31_false:                                 ; preds = %bb_while_4_29_whilestms
...
bb_if_8_31_end:                                   ; preds = %bb_if_8_31_false, %bb_if_8_31_true
  br label %bb_while_4_29_cond

bb_while_4_29_bre:                                ; preds = %bb21_29checksecond, %bb_while_4_29_cond
  br label %bb_while_4_42_cond

bb_while_4_42_cond:                               ; preds = %bb_while_4_42_whilestms, %bb_while_4_29_bre
  %r182 = load i32, ptr %r118, align 4
  %r183 = load i32, ptr %r107, align 4
  %r184 = icmp slt i32 %r182, %r183
  br i1 %r184, label %bb_while_4_42_whilestms, label %bb_while_4_42_bre

bb_while_4_42_whilestms:                          ; preds = %bb_while_4_42_cond
...
bb_while_4_42_bre:                                ; preds = %bb_while_4_42_cond
  br label %bb_while_4_47_cond

bb_while_4_47_cond:                               ; preds = %bb_while_4_47_whilestms, %bb_while_4_42_bre
  %r194 = load i32, ptr %r119, align 4
  %r195 = load i32, ptr %r112, align 4
  %r196 = icmp slt i32 %r194, %r195
  br i1 %r196, label %bb_while_4_47_whilestms, label %bb_while_4_47_bre

bb_while_4_47_whilestms:                          ; preds = %bb_while_4_47_cond
...
bb_while_4_47_bre:                                ; preds = %bb_while_4_47_cond
  ret i32 0
}
...
bb2:                                              ; preds = %bb5
  ...
  br i1 %r213, label %bb_if_4_57_true, label %bb_if_4_57_false

bb_if_4_57_true:                                  ; preds = %bb2
  ...
  br label %bb_if_4_57_end

bb_if_4_57_false:                                 ; preds = %bb2
  br label %bb_if_4_57_end

bb_if_4_57_end:                                   ; preds = %bb_if_4_57_false, %bb_if_4_57_true
  ret i32 0
}
...
bb3:                                              ; preds = %bb6
  ...
  br label %bb_while_4_80_cond

bb_while_4_80_cond:                               ; preds = %bb_while_4_80_whilestms, %bb3
  %r251 = load i32, ptr %r243, align 4
  %r252 = load i32, ptr @n, align 4
  %r253 = icmp slt i32 %r251, %r252
  br i1 %r253, label %bb_while_4_80_whilestms, label %bb_while_4_80_bre

bb_while_4_80_whilestms:                          ; preds = %bb_while_4_80_cond
...
bb_while_4_80_bre:                                ; preds = %bb_while_4_80_cond
  ret i32 0
}

...
bb1:                                              ; preds = %bb3
  ...
  br i1 %r105, label %bb_if_4_2_true, label %bb17_2checksecond

bb17_2checksecond:                                ; preds = %bb1
  %r106 = load i32, ptr %r103, align 4
  %r107 = icmp eq i32 %r106, 1
  br i1 %r107, label %bb_if_4_2_true, label %bb_if_4_2_false

bb_if_4_2_true:                                   ; preds = %bb17_2checksecond, %bb1
  ret i32 1

bb_if_4_2_false:                                  ; preds = %bb17_2checksecond
...
bb_while_4_14_cond:                               ; preds = %bb_while_4_14_whilestms, %bb_if_4_2_end
  %r114 = load i32, ptr %r109, align 4
  %r115 = load i32, ptr %r101, align 4
  %r116 = icmp slt i32 %r114, %r115
  br i1 %r116, label %bb_while_4_14_whilestms, label %bb_while_4_14_bre
...
bb_while_4_20_cond:                               ; preds = %bb_while_4_20_whilestms, %bb_while_4_14_bre
  %r126 = load i32, ptr %r109, align 4
  %r127 = load i32, ptr %r103, align 4
  %r128 = icmp slt i32 %r126, %r127
  br i1 %r128, label %bb_while_4_20_whilestms, label %bb_while_4_20_bre
...
bb_while_4_26_cond:                               ; preds = %bb_while_8_28_bre, %bb_while_4_20_bre
  %r140 = load i32, ptr %r109, align 4
  %r141 = sub i32 0, 1
  %r142 = icmp sgt i32 %r140, %r141
  br i1 %r142, label %bb_while_4_26_whilestms, label %bb_while_4_26_bre

bb_while_4_26_whilestms:                          ; preds = %bb_while_4_26_cond
  %r143 = load i32, ptr %r103, align 4
  %r144 = sub i32 %r143, 2
  store i32 %r144, ptr %r110, align 4
  br label %bb_while_8_28_cond

bb_while_8_28_cond:                               ; preds = %bb_while_8_28_whilestms, %bb_while_4_26_whilestms
  %r145 = load i32, ptr %r110, align 4
  %r146 = sub i32 0, 1
  %r147 = icmp sgt i32 %r145, %r146
  br i1 %r147, label %bb_while_8_28_whilestms, label %bb_while_8_28_bre

bb_while_8_28_whilestms:                          ; preds = %bb_while_8_28_cond
...
bb_while_8_28_bre:                                ; preds = %bb_while_8_28_cond

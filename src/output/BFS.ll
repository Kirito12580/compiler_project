...
bb1:                                              ; preds = %bb8
  ...
  br label %bb_while_4_5_cond

bb_while_4_5_cond:                                ; preds = %bb_if_8_6_end, %bb1
  %r104 = load i32, ptr %r100, align 4
  %r105 = icmp slt i32 %r104, 48
  br i1 %r105, label %bb_while_4_5_whilestms, label %bb24_5checksecond

bb24_5checksecond:                                ; preds = %bb_while_4_5_cond
  %r106 = load i32, ptr %r100, align 4
  %r107 = icmp sgt i32 %r106, 57
  br i1 %r107, label %bb_while_4_5_whilestms, label %bb_while_4_5_bre

bb_while_4_5_whilestms:                           ; preds = %bb24_5checksecond, %bb_while_4_5_cond
  %r108 = load i32, ptr %r100, align 4
  %r109 = icmp eq i32 %r108, 45
  br i1 %r109, label %bb_if_8_6_true, label %bb_if_8_6_false

bb_if_8_6_true:                                   ; preds = %bb_while_4_5_whilestms
  store i32 1, ptr %r103, align 4
  br label %bb_if_8_6_end

bb_if_8_6_false:                                  ; preds = %bb_while_4_5_whilestms
  br label %bb_if_8_6_end

bb_if_8_6_end:                                    ; preds = %bb_if_8_6_false, %bb_if_8_6_true
  %r110 = call i32 @getch()
  store i32 %r110, ptr %r100, align 4
  br label %bb_while_4_5_cond

bb_while_4_5_bre:                                 ; preds = %bb24_5checksecond
  br label %bb_while_4_11_cond

bb_while_4_11_cond:                               ; preds = %bb_while_4_11_whilestms, %bb_while_4_5_bre
  %r111 = load i32, ptr %r100, align 4
  %r112 = icmp sge i32 %r111, 48
  br i1 %r112, label %bb25_11checksecond, label %bb_while_4_11_bre

bb25_11checksecond:                               ; preds = %bb_while_4_11_cond
  %r113 = load i32, ptr %r100, align 4
  %r114 = icmp sle i32 %r113, 57
  br i1 %r114, label %bb_while_4_11_whilestms, label %bb_while_4_11_bre

bb_while_4_11_whilestms:                          ; preds = %bb25_11checksecond
...
bb_while_4_11_bre:                                ; preds = %bb25_11checksecond, %bb_while_4_11_cond
  %r121 = load i32, ptr %r103, align 4
  %r122 = icmp ne i32 %r121, 0
  br i1 %r122, label %bb_if_4_15_true, label %bb_if_4_15_false

bb_if_4_15_true:                                  ; preds = %bb_while_4_11_bre
  %r123 = load i32, ptr %r102, align 4
  %r124 = sub i32 0, %r123
  ret i32 %r124

bb_if_4_15_false:                                 ; preds = %bb_while_4_11_bre
  %r125 = load i32, ptr %r102, align 4
  ret i32 %r125

bb_if_4_15_end:                                   ; No predecessors!
  ret i32 -1
}
...
bb3:                                              ; preds = %bb10
  ...
  br label %bb_while_4_46_cond

bb_while_4_46_cond:                               ; preds = %bb_while_4_46_whilestms, %bb3
  %r157 = load i32, ptr %r156, align 4
  %r158 = icmp slt i32 %r157, 1005
  br i1 %r158, label %bb_while_4_46_whilestms, label %bb_while_4_46_bre

bb_while_4_46_whilestms:                          ; preds = %bb_while_4_46_cond
...
bb_while_4_46_bre:                                ; preds = %bb_while_4_46_cond
  ret void
}
...
bb6:                                              ; preds = %bb13
  ...
  br label %bb_while_4_72_cond

bb_while_4_72_cond:                               ; preds = %bb_while_8_78_bre, %bb6
  %r191 = load i32, ptr @h, align 4
  %r192 = load i32, ptr @tail, align 4
  %r193 = icmp slt i32 %r191, %r192
  br i1 %r193, label %bb_while_4_72_whilestms, label %bb_while_4_72_bre

bb_while_4_72_whilestms:                          ; preds = %bb_while_4_72_cond
  ...
  br i1 %r197, label %bb_if_8_74_true, label %bb_if_8_74_false

bb_if_8_74_true:                                  ; preds = %bb_while_4_72_whilestms
  store i32 1, ptr %r187, align 4
  br label %bb_if_8_74_end

bb_if_8_74_false:                                 ; preds = %bb_while_4_72_whilestms
  br label %bb_if_8_74_end

bb_if_8_74_end:                                   ; preds = %bb_if_8_74_false, %bb_if_8_74_true
  ...
  br label %bb_while_8_78_cond

bb_while_8_78_cond:                               ; preds = %bb_if_12_80_end, %bb_if_8_74_end
  %r201 = load i32, ptr %r189, align 4
  %r202 = sub i32 0, 1
  %r203 = icmp ne i32 %r201, %r202
  br i1 %r203, label %bb_while_8_78_whilestms, label %bb_while_8_78_bre

bb_while_8_78_whilestms:                          ; preds = %bb_while_8_78_cond
  ...
  br i1 %r210, label %bb_if_12_80_true, label %bb_if_12_80_false

bb_if_12_80_true:                                 ; preds = %bb_while_8_78_whilestms
  ...
  br label %bb_if_12_80_end

bb_if_12_80_false:                                ; preds = %bb_while_8_78_whilestms
  br label %bb_if_12_80_end

bb_if_12_80_end:                                  ; preds = %bb_if_12_80_false, %bb_if_12_80_true
...
bb_while_8_78_bre:                                ; preds = %bb_while_8_78_cond
  br label %bb_while_4_72_cond

bb_while_4_72_bre:                                ; preds = %bb_while_4_72_cond
  store i32 0, ptr %r189, align 4
  br label %bb_while_4_87_cond

bb_while_4_87_cond:                               ; preds = %bb_while_4_87_whilestms, %bb_while_4_72_bre
  %r217 = load i32, ptr %r189, align 4
  %r218 = load i32, ptr @tail, align 4
  %r219 = icmp sle i32 %r217, %r218
  br i1 %r219, label %bb_while_4_87_whilestms, label %bb_while_4_87_bre

bb_while_4_87_whilestms:                          ; preds = %bb_while_4_87_cond
...
bb_while_4_87_bre:                                ; preds = %bb_while_4_87_cond
...
bb7:                                              ; preds = %bb14
  ...
  br label %bb_while_4_101_cond

bb_while_4_101_cond:                              ; preds = %bb_if_8_106_end, %bb7
  %r233 = load i32, ptr @m, align 4
  %r234 = icmp ne i32 %r233, 0
  br i1 %r234, label %bb_while_4_101_whilestms, label %bb_while_4_101_bre

bb_while_4_101_whilestms:                         ; preds = %bb_while_4_101_cond
  %r235 = call i32 @getch()
  store i32 %r235, ptr %r230, align 4
  br label %bb_while_8_103_cond

bb_while_8_103_cond:                              ; preds = %bb_while_8_103_whilestms, %bb_while_4_101_whilestms
  %r236 = load i32, ptr %r230, align 4
  %r237 = icmp ne i32 %r236, 81
  br i1 %r237, label %bb29_103checksecond, label %bb_while_8_103_bre

bb29_103checksecond:                              ; preds = %bb_while_8_103_cond
  %r238 = load i32, ptr %r230, align 4
  %r239 = icmp ne i32 %r238, 85
  br i1 %r239, label %bb_while_8_103_whilestms, label %bb_while_8_103_bre

bb_while_8_103_whilestms:                         ; preds = %bb29_103checksecond
  %r240 = call i32 @getch()
  store i32 %r240, ptr %r230, align 4
  br label %bb_while_8_103_cond

bb_while_8_103_bre:                               ; preds = %bb29_103checksecond, %bb_while_8_103_cond
  %r241 = load i32, ptr %r230, align 4
  %r242 = icmp eq i32 %r241, 81
  br i1 %r242, label %bb_if_8_106_true, label %bb_if_8_106_false

bb_if_8_106_true:                                 ; preds = %bb_while_8_103_bre
  ...
  br label %bb_if_8_106_end

bb_if_8_106_false:                                ; preds = %bb_while_8_103_bre
...
bb_if_8_106_end:                                  ; preds = %bb_if_8_106_false, %bb_if_8_106_true
  %r252 = load i32, ptr @m, align 4
  %r253 = sub i32 %r252, 1
  store i32 %r253, ptr @m, align 4
  br label %bb_while_4_101_cond

bb_while_4_101_bre:                               ; preds = %bb_while_4_101_cond
  ret i32 0
}

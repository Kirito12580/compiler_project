...
bb_while_4_5_cond:                                ; preds = %bb_while_4_5_whilestms, %bb1
  %r102 = load i32, ptr %r101, align 4
  %r103 = icmp slt i32 %r102, 10
  br i1 %r103, label %bb_while_4_5_whilestms, label %bb_while_4_5_bre
...
bb_while_4_17_cond:                               ; preds = %bb_while_4_17_whilestms, %bb2
  %r112 = load i32, ptr %r109, align 4
  %r113 = icmp slt i32 %r112, 10
  br i1 %r113, label %bb_while_4_17_whilestms, label %bb_while_4_17_bre
...
bb_while_4_17_bre:                                ; preds = %bb_while_4_17_cond

...
bb2:                                              ; preds = %bb5
  ...
  br label %bb_while_4_12_cond

bb_while_4_12_cond:                               ; preds = %bb_while_4_12_whilestms, %bb2
  %r116 = load i32, ptr %r114, align 4
  %r117 = icmp slt i32 %r116, 4
  br i1 %r117, label %bb_while_4_12_whilestms, label %bb_while_4_12_bre

bb_while_4_12_whilestms:                          ; preds = %bb_while_4_12_cond
...
bb_while_4_12_bre:                                ; preds = %bb_while_4_12_cond
  ...
  br i1 %r130, label %bb21_19checksecond, label %bb_if_4_19_false

bb21_19checksecond:                               ; preds = %bb_while_4_12_bre
  ...
  br i1 %r135, label %bb_if_4_19_true, label %bb_if_4_19_false

bb_if_4_19_true:                                  ; preds = %bb21_19checksecond
  store i32 1, ptr %r115, align 4
  br label %bb_if_4_19_end

bb_if_4_19_false:                                 ; preds = %bb21_19checksecond, %bb_while_4_12_bre
  store i32 0, ptr %r115, align 4
  br label %bb_if_4_19_end

bb_if_4_19_end:                                   ; preds = %bb_if_4_19_false, %bb_if_4_19_true

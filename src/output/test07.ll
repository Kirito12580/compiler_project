...
bb1:                                              ; preds = %bb2
  ...
  br i1 %r103, label %bb27_4checksecond, label %bb16_4false

bb27_4checksecond:                                ; preds = %bb1
  %r104 = load i32, ptr %r100, align 4
  %r105 = icmp sgt i32 %r104, 0
  br i1 %r105, label %bb16_4true, label %bb16_4false

bb16_4true:                                       ; preds = %bb27_4checksecond
  store i32 1, ptr %r102, align 4
  br label %bb16_4end

bb16_4false:                                      ; preds = %bb27_4checksecond, %bb1
  store i32 0, ptr %r102, align 4
  br label %bb16_4end

bb16_4end:                                        ; preds = %bb16_4false, %bb16_4true
  %r106 = load i32, ptr %r102, align 4
  store i32 %r106, ptr %r101, align 4
  br label %bb_while_4_5_cond

bb_while_4_5_cond:                                ; preds = %bb_while_4_5_whilestms, %bb16_4end
  %r107 = load i32, ptr %r100, align 4
  %r108 = icmp slt i32 %r107, 1000000
  br i1 %r108, label %bb_while_4_5_whilestms, label %bb_while_4_5_bre

bb_while_4_5_whilestms:                           ; preds = %bb_while_4_5_cond
...
bb_while_4_5_bre:                                 ; preds = %bb_while_4_5_cond

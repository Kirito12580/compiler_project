...
bb_while_4_14_cond:                               ; preds = %bb_while_4_14_whilestms, %bb2
  %r117 = load i32, ptr %r114, align 4
  %r118 = sub i32 0, 1
  %r119 = icmp ne i32 %r117, %r118
  br i1 %r119, label %bb_while_4_14_whilestms, label %bb_while_4_14_bre
...
bb3:                                              ; preds = %bb6
  ...
  br label %bb_while_4_35_cond

bb_while_4_35_cond:                               ; preds = %bb_while_4_35_whilestms, %bb3
  %r135 = load i32, ptr %r128, align 4
  %r136 = icmp slt i32 %r135, 4
  br i1 %r136, label %bb_while_4_35_whilestms, label %bb_while_4_35_bre

bb_while_4_35_whilestms:                          ; preds = %bb_while_4_35_cond
...
bb_while_4_35_bre:                                ; preds = %bb_while_4_35_cond
  ret i32 0
}

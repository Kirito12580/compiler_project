...
bb2:                                              ; preds = %bb5
  ...
  br i1 %r115, label %bb_if_4_8_true, label %bb_if_4_8_false

bb_if_4_8_true:                                   ; preds = %bb2
  %r116 = load i32, ptr %r109, align 4
  %r117 = load i32, ptr %r113, align 4
  call void @move(i32 %r116, i32 %r117)
  br label %bb_if_4_8_end

bb_if_4_8_false:                                  ; preds = %bb2
...
bb_if_4_8_end:                                    ; preds = %bb_if_4_8_false, %bb_if_4_8_true
  ret void
}
...
bb3:                                              ; preds = %bb6
  ...
  br label %bb_while_4_22_cond

bb_while_4_22_cond:                               ; preds = %bb_while_4_22_whilestms, %bb3
  %r132 = load i32, ptr %r130, align 4
  %r133 = icmp sgt i32 %r132, 0
  br i1 %r133, label %bb_while_4_22_whilestms, label %bb_while_4_22_bre

bb_while_4_22_whilestms:                          ; preds = %bb_while_4_22_cond
...
bb_while_4_22_bre:                                ; preds = %bb_while_4_22_cond
  ret i32 0
}

...
bb1:                                              ; preds = %bb4
  ...
  br i1 %r103, label %bb_if_4_3_true, label %bb_if_4_3_false

bb_if_4_3_true:                                   ; preds = %bb1
  ret i32 127

bb_if_4_3_false:                                  ; preds = %bb1
  br label %bb_if_4_3_end

bb_if_4_3_end:                                    ; preds = %bb_if_4_3_false
  %r104 = load i32, ptr %r101, align 4
  %r105 = icmp slt i32 %r104, 0
  br i1 %r105, label %bb_if_4_7_true, label %bb_if_4_7_false

bb_if_4_7_true:                                   ; preds = %bb_if_4_3_end
  ret i32 0

bb_if_4_7_false:                                  ; preds = %bb_if_4_3_end
  br label %bb_if_4_7_end

bb_if_4_7_end:                                    ; preds = %bb_if_4_7_false
...
bb2:                                              ; preds = %bb5
  ...
  br i1 %r1754, label %bb_if_4_20_true, label %bb_if_4_20_false

bb_if_4_20_true:                                  ; preds = %bb2
  ret i32 1

bb_if_4_20_false:                                 ; preds = %bb2
  br label %bb_if_4_20_end

bb_if_4_20_end:                                   ; preds = %bb_if_4_20_false
  ret i32 0
}
...
bb3:                                              ; preds = %bb6
  ...
  br label %bb_while_4_39_cond

bb_while_4_39_cond:                               ; preds = %bb_if_8_49_end, %bb3
  %r1758 = load i32, ptr %r1755, align 4
  %r1759 = icmp sgt i32 %r1758, 0
  br i1 %r1759, label %bb_while_4_39_whilestms, label %bb_while_4_39_bre

bb_while_4_39_whilestms:                          ; preds = %bb_while_4_39_cond
  store i32 0, ptr %r1760, align 4
  br label %bb_while_8_41_cond

bb_while_8_41_cond:                               ; preds = %bb_while_12_43_bre, %bb_while_4_39_whilestms
  %r1761 = load i32, ptr %r1760, align 4
  %r1762 = icmp slt i32 %r1761, 5
  br i1 %r1762, label %bb_while_8_41_whilestms, label %bb_while_8_41_bre

bb_while_8_41_whilestms:                          ; preds = %bb_while_8_41_cond
  store i32 0, ptr %r1763, align 4
  br label %bb_while_12_43_cond

bb_while_12_43_cond:                              ; preds = %bb_while_12_43_whilestms, %bb_while_8_41_whilestms
  %r1764 = load i32, ptr %r1763, align 4
  %r1765 = icmp slt i32 %r1764, 5
  br i1 %r1765, label %bb_while_12_43_whilestms, label %bb_while_12_43_bre

bb_while_12_43_whilestms:                         ; preds = %bb_while_12_43_cond
...
bb_while_12_43_bre:                               ; preds = %bb_while_12_43_cond
  %r1774 = load i32, ptr %r1760, align 4
  %r1775 = add i32 %r1774, 1
  store i32 %r1775, ptr %r1760, align 4
  br label %bb_while_8_41_cond

bb_while_8_41_bre:                                ; preds = %bb_while_8_41_cond
  %r1776 = getelementptr [5 x %array2D], ptr %r1757, i32 0, i32 0
  %r1777 = call i32 @model(ptr %r1776)
  %r1778 = icmp ne i32 %r1777, 0
  br i1 %r1778, label %bb_if_8_49_true, label %bb_if_8_49_false

bb_if_8_49_true:                                  ; preds = %bb_while_8_41_bre
  call void @putch(i32 99)
  call void @putch(i32 97)
  call void @putch(i32 116)
  call void @putch(i32 10)
  br label %bb_if_8_49_end

bb_if_8_49_false:                                 ; preds = %bb_while_8_41_bre
...
bb_if_8_49_end:                                   ; preds = %bb_if_8_49_false, %bb_if_8_49_true
  %r1779 = load i32, ptr %r1755, align 4
  %r1780 = sub i32 %r1779, 1
  store i32 %r1780, ptr %r1755, align 4
  br label %bb_while_4_39_cond

bb_while_4_39_bre:                                ; preds = %bb_while_4_39_cond
  ret i32 0
}

...
bb1:                                              ; preds = %bb3
  ...
  br i1 %r104, label %bb_if_4_2_true, label %bb_if_4_2_false

bb_if_4_2_true:                                   ; preds = %bb1
  ret i32 1

bb_if_4_2_false:                                  ; preds = %bb1
  br label %bb_if_4_2_end

bb_if_4_2_end:                                    ; preds = %bb_if_4_2_false
  ...
  br i1 %r109, label %bb_if_4_6_true, label %bb_if_4_6_false

bb_if_4_6_true:                                   ; preds = %bb_if_4_2_end
  ret i32 1

bb_if_4_6_false:                                  ; preds = %bb_if_4_2_end
  br label %bb_if_4_6_end

bb_if_4_6_end:                                    ; preds = %bb_if_4_6_false
  store i32 0, ptr %r111, align 4
  br label %bb_while_4_13_cond

bb_while_4_13_cond:                               ; preds = %bb_while_4_13_whilestms, %bb_if_4_6_end
  %r112 = load i32, ptr %r111, align 4
  %r113 = load i32, ptr %r102, align 4
  %r114 = sub i32 %r113, 1
  %r115 = icmp slt i32 %r112, %r114
  br i1 %r115, label %bb_while_4_13_whilestms, label %bb_while_4_13_bre

bb_while_4_13_whilestms:                          ; preds = %bb_while_4_13_cond
...
bb_while_4_13_bre:                                ; preds = %bb_while_4_13_cond
...
bb_while_4_20_cond:                               ; preds = %bb_while_8_29_bre, %bb_while_4_13_bre
  %r127 = load i32, ptr %r111, align 4
  %r128 = sub i32 0, 1
  %r129 = icmp sgt i32 %r127, %r128
  br i1 %r129, label %bb_while_4_20_whilestms, label %bb_while_4_20_bre
...
bb_while_4_20_whilestms:                          ; preds = %bb_while_4_20_cond
  ...
  br i1 %r138, label %bb_if_8_22_true, label %bb_if_8_22_false

bb_if_8_22_true:                                  ; preds = %bb_while_4_20_whilestms
  ...
  br label %bb_if_8_22_end

bb_if_8_22_false:                                 ; preds = %bb_while_4_20_whilestms
...
bb_if_8_22_end:                                   ; preds = %bb_if_8_22_false, %bb_if_8_22_true
  br label %bb_while_8_29_cond

bb_while_8_29_cond:                               ; preds = %bb_if_12_31_end, %bb_if_8_22_end
  %r146 = load i32, ptr %r130, align 4
  %r147 = sub i32 0, 1
  %r148 = icmp sgt i32 %r146, %r147
  br i1 %r148, label %bb_while_8_29_whilestms, label %bb_while_8_29_bre

bb_while_8_29_whilestms:                          ; preds = %bb_while_8_29_cond
  ...
  br i1 %r155, label %bb_if_12_31_true, label %bb_if_12_31_false

bb_if_12_31_true:                                 ; preds = %bb_while_8_29_whilestms
...
bb_if_12_31_false:                                ; preds = %bb_while_8_29_whilestms
  br label %bb_if_12_31_end
...
bb_while_8_29_bre:                                ; preds = %bb_while_8_29_cond

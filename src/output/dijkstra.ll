...
bb1:                                              ; preds = %bb3
  ...
  br label %bb_while_4_18_cond

bb_while_4_18_cond:                               ; preds = %bb_while_4_18_whilestms, %bb1
  %r101 = load i32, ptr %r100, align 4
  %r102 = load i32, ptr @n, align 4
  %r103 = icmp sle i32 %r101, %r102
  br i1 %r103, label %bb_while_4_18_whilestms, label %bb_while_4_18_bre

bb_while_4_18_whilestms:                          ; preds = %bb_while_4_18_cond
...
bb_while_4_18_bre:                                ; preds = %bb_while_4_18_cond
  %r115 = getelementptr [16 x i32], ptr @book, i32 0, i32 1
  store i32 1, ptr %r115, align 4
  store i32 1, ptr %r100, align 4
  br label %bb_while_4_26_cond

bb_while_4_26_cond:                               ; preds = %bb_while_8_39_bre, %bb_while_4_18_bre
  %r116 = load i32, ptr %r100, align 4
  %r117 = load i32, ptr @n, align 4
  %r118 = sub i32 %r117, 1
  %r119 = icmp sle i32 %r116, %r118
  br i1 %r119, label %bb_while_4_26_whilestms, label %bb_while_4_26_bre

bb_while_4_26_whilestms:                          ; preds = %bb_while_4_26_cond
  %r121 = load i32, ptr @INF, align 4
  store i32 %r121, ptr %r120, align 4
  store i32 0, ptr %r122, align 4
  store i32 1, ptr %r123, align 4
  br label %bb_while_8_30_cond

bb_while_8_30_cond:                               ; preds = %bb_if_12_31_end, %bb_while_4_26_whilestms
  %r124 = load i32, ptr %r123, align 4
  %r125 = load i32, ptr @n, align 4
  %r126 = icmp sle i32 %r124, %r125
  br i1 %r126, label %bb_while_8_30_whilestms, label %bb_while_8_30_bre

bb_while_8_30_whilestms:                          ; preds = %bb_while_8_30_cond
  ...
  br i1 %r131, label %bb36_31checksecond, label %bb_if_12_31_false

bb36_31checksecond:                               ; preds = %bb_while_8_30_whilestms
  ...
  br i1 %r135, label %bb_if_12_31_true, label %bb_if_12_31_false

bb_if_12_31_true:                                 ; preds = %bb36_31checksecond
  ...
  br label %bb_if_12_31_end

bb_if_12_31_false:                                ; preds = %bb36_31checksecond, %bb_while_8_30_whilestms
  br label %bb_if_12_31_end

bb_if_12_31_end:                                  ; preds = %bb_if_12_31_false, %bb_if_12_31_true
  %r140 = load i32, ptr %r123, align 4
  %r141 = add i32 %r140, 1
  store i32 %r141, ptr %r123, align 4
  br label %bb_while_8_30_cond

bb_while_8_30_bre:                                ; preds = %bb_while_8_30_cond
...
bb_while_8_39_cond:                               ; preds = %bb_if_12_40_end, %bb_while_8_30_bre
  %r145 = load i32, ptr %r144, align 4
  %r146 = load i32, ptr @n, align 4
  %r147 = icmp sle i32 %r145, %r146
  br i1 %r147, label %bb_while_8_39_whilestms, label %bb_while_8_39_bre
...
bb_while_8_39_whilestms:                          ; preds = %bb_while_8_39_cond
  ...
  br i1 %r155, label %bb_if_12_40_true, label %bb_if_12_40_false

bb_if_12_40_true:                                 ; preds = %bb_while_8_39_whilestms
  ...
  br i1 %r169, label %bb_if_16_41_true, label %bb_if_16_41_false

bb_if_16_41_true:                                 ; preds = %bb_if_12_40_true
  ...
  br label %bb_if_16_41_end

bb_if_16_41_false:                                ; preds = %bb_if_12_40_true
  br label %bb_if_16_41_end

bb_if_16_41_end:                                  ; preds = %bb_if_16_41_false, %bb_if_16_41_true
  br label %bb_if_12_40_end

bb_if_12_40_false:                                ; preds = %bb_while_8_39_whilestms
  br label %bb_if_12_40_end

bb_if_12_40_end:                                  ; preds = %bb_if_12_40_false, %bb_if_16_41_end
...
bb_while_4_26_bre:                                ; preds = %bb_while_4_26_cond
  ret void
}
...
bb2:                                              ; preds = %bb4
  ...
  br label %bb_while_4_58_cond

bb_while_4_58_cond:                               ; preds = %bb_while_8_60_bre, %bb2
  %r189 = load i32, ptr %r186, align 4
  %r190 = load i32, ptr @n, align 4
  %r191 = icmp sle i32 %r189, %r190
  br i1 %r191, label %bb_while_4_58_whilestms, label %bb_while_4_58_bre

bb_while_4_58_whilestms:                          ; preds = %bb_while_4_58_cond
  store i32 1, ptr %r192, align 4
  br label %bb_while_8_60_cond

bb_while_8_60_cond:                               ; preds = %bb_if_12_61_end, %bb_while_4_58_whilestms
  %r193 = load i32, ptr %r192, align 4
  %r194 = load i32, ptr @n, align 4
  %r195 = icmp sle i32 %r193, %r194
  br i1 %r195, label %bb_while_8_60_whilestms, label %bb_while_8_60_bre

bb_while_8_60_whilestms:                          ; preds = %bb_while_8_60_cond
  %r196 = load i32, ptr %r186, align 4
  %r197 = load i32, ptr %r192, align 4
  %r198 = icmp eq i32 %r196, %r197
  br i1 %r198, label %bb_if_12_61_true, label %bb_if_12_61_false

bb_if_12_61_true:                                 ; preds = %bb_while_8_60_whilestms
  ...
  br label %bb_if_12_61_end

bb_if_12_61_false:                                ; preds = %bb_while_8_60_whilestms
...
bb_if_12_61_end:                                  ; preds = %bb_if_12_61_false, %bb_if_12_61_true
  %r210 = load i32, ptr %r192, align 4
  %r211 = add i32 %r210, 1
  store i32 %r211, ptr %r192, align 4
  br label %bb_while_8_60_cond

bb_while_8_60_bre:                                ; preds = %bb_while_8_60_cond
  %r212 = load i32, ptr %r186, align 4
  %r213 = add i32 %r212, 1
  store i32 %r213, ptr %r186, align 4
  br label %bb_while_4_58_cond

bb_while_4_58_bre:                                ; preds = %bb_while_4_58_cond
  store i32 1, ptr %r186, align 4
  br label %bb_while_4_75_cond

bb_while_4_75_cond:                               ; preds = %bb_while_4_75_whilestms, %bb_while_4_58_bre
  %r214 = load i32, ptr %r186, align 4
  %r215 = load i32, ptr @m, align 4
  %r216 = icmp sle i32 %r214, %r215
  br i1 %r216, label %bb_while_4_75_whilestms, label %bb_while_4_75_bre

bb_while_4_75_whilestms:                          ; preds = %bb_while_4_75_cond
...
bb_while_4_75_bre:                                ; preds = %bb_while_4_75_cond
  call void @Dijkstra()
  store i32 1, ptr %r186, align 4
  br label %bb_while_4_85_cond

bb_while_4_85_cond:                               ; preds = %bb_while_4_85_whilestms, %bb_while_4_75_bre
  %r229 = load i32, ptr %r186, align 4
  %r230 = load i32, ptr @n, align 4
  %r231 = icmp sle i32 %r229, %r230
  br i1 %r231, label %bb_while_4_85_whilestms, label %bb_while_4_85_bre

bb_while_4_85_whilestms:                          ; preds = %bb_while_4_85_cond
...
bb_while_4_85_bre:                                ; preds = %bb_while_4_85_cond

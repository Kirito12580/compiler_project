...
bb3:                                              ; preds = %bb9
  ...
  br label %bb_while_4_43_cond

bb_while_4_43_cond:                               ; preds = %bb_while_4_43_whilestms, %bb3
  %r157 = load i32, ptr %r156, align 4
  %r158 = icmp slt i32 %r157, 1005
  br i1 %r158, label %bb_while_4_43_whilestms, label %bb_while_4_43_bre

bb_while_4_43_whilestms:                          ; preds = %bb_while_4_43_cond
...
bb_while_4_43_bre:                                ; preds = %bb_while_4_43_cond
  ret void
}
...
bb4:                                              ; preds = %bb10
  ...
  br label %bb_while_4_51_cond

bb_while_4_51_cond:                               ; preds = %bb_while_4_51_whilestms, %bb4
  %r165 = load i32, ptr %r164, align 4
  %r166 = load i32, ptr @n, align 4
  %r167 = icmp sle i32 %r165, %r166
  br i1 %r167, label %bb_while_4_51_whilestms, label %bb_while_4_51_bre

bb_while_4_51_whilestms:                          ; preds = %bb_while_4_51_cond
...
bb_while_4_51_bre:                                ; preds = %bb_while_4_51_cond
  ret void
}
...
bb5:                                              ; preds = %bb11
  ...
  br i1 %r180, label %bb_if_4_59_true, label %bb_if_4_59_false

bb_if_4_59_true:                                  ; preds = %bb5
  ret i32 1

bb_if_4_59_false:                                 ; preds = %bb5
  br label %bb_if_4_59_end

bb_if_4_59_end:                                   ; preds = %bb_if_4_59_false
  ...
  br label %bb_while_4_63_cond

bb_while_4_63_cond:                               ; preds = %bb_if_8_65_end, %bb_if_4_59_end
  %r185 = load i32, ptr %r181, align 4
  %r186 = sub i32 0, 1
  %r187 = icmp ne i32 %r185, %r186
  br i1 %r187, label %bb_while_4_63_whilestms, label %bb_while_4_63_bre

bb_while_4_63_whilestms:                          ; preds = %bb_while_4_63_cond
  ...
  br i1 %r195, label %bb25_65checksecond, label %bb_if_8_65_false

bb25_65checksecond:                               ; preds = %bb_while_4_63_whilestms
  %r196 = load i32, ptr %r188, align 4
  %r197 = load i32, ptr %r175, align 4
  %r198 = call i32 @same(i32 %r196, i32 %r197)
  %r199 = icmp ne i32 %r198, 0
  br i1 %r199, label %bb_if_8_65_true, label %bb_if_8_65_false

bb_if_8_65_true:                                  ; preds = %bb25_65checksecond
  ret i32 1

bb_if_8_65_false:                                 ; preds = %bb25_65checksecond, %bb_while_4_63_whilestms
  br label %bb_if_8_65_end

bb_if_8_65_end:                                   ; preds = %bb_if_8_65_false
...
bb_while_4_63_bre:                                ; preds = %bb_while_4_63_cond
  ret i32 0
}
...
bb6:                                              ; preds = %bb12
  ...
  br label %bb_while_4_79_cond

bb_while_4_79_cond:                               ; preds = %bb_if_8_84_end, %bb6
  %r208 = load i32, ptr @m, align 4
  %r209 = icmp ne i32 %r208, 0
  br i1 %r209, label %bb_while_4_79_whilestms, label %bb_while_4_79_bre

bb_while_4_79_whilestms:                          ; preds = %bb_while_4_79_cond
  %r210 = call i32 @getch()
  store i32 %r210, ptr %r205, align 4
  br label %bb_while_8_81_cond

bb_while_8_81_cond:                               ; preds = %bb_while_8_81_whilestms, %bb_while_4_79_whilestms
  %r211 = load i32, ptr %r205, align 4
  %r212 = icmp ne i32 %r211, 81
  br i1 %r212, label %bb27_81checksecond, label %bb_while_8_81_bre

bb27_81checksecond:                               ; preds = %bb_while_8_81_cond
  %r213 = load i32, ptr %r205, align 4
  %r214 = icmp ne i32 %r213, 85
  br i1 %r214, label %bb_while_8_81_whilestms, label %bb_while_8_81_bre

bb_while_8_81_whilestms:                          ; preds = %bb27_81checksecond
  %r215 = call i32 @getch()
  store i32 %r215, ptr %r205, align 4
  br label %bb_while_8_81_cond

bb_while_8_81_bre:                                ; preds = %bb27_81checksecond, %bb_while_8_81_cond
  %r216 = load i32, ptr %r205, align 4
  %r217 = icmp eq i32 %r216, 81
  br i1 %r217, label %bb_if_8_84_true, label %bb_if_8_84_false

bb_if_8_84_true:                                  ; preds = %bb_while_8_81_bre
  ...
  br label %bb_if_8_84_end

bb_if_8_84_false:                                 ; preds = %bb_while_8_81_bre
...
bb_if_8_84_end:                                   ; preds = %bb_if_8_84_false, %bb_if_8_84_true
  %r227 = load i32, ptr @m, align 4
  %r228 = sub i32 %r227, 1
  store i32 %r228, ptr @m, align 4
  br label %bb_while_4_79_cond

bb_while_4_79_bre:                                ; preds = %bb_while_4_79_cond
  ret i32 0
}

...
bb2:                                              ; preds = %bb4
  ...
  br i1 %r105, label %bb_if_4_11_true, label %bb21_11checksecond

bb21_11checksecond:                               ; preds = %bb2
  %r106 = call i32 @foo(i32 3)
  %r107 = icmp sgt i32 %r106, 0
  br i1 %r107, label %bb_if_4_11_true, label %bb_if_4_11_false

bb_if_4_11_true:                                  ; preds = %bb21_11checksecond, %bb2
  store i32 2, ptr %r103, align 4
  br label %bb_if_4_11_end

bb_if_4_11_false:                                 ; preds = %bb21_11checksecond
  br label %bb_if_4_11_end

bb_if_4_11_end:                                   ; preds = %bb_if_4_11_false, %bb_if_4_11_true
